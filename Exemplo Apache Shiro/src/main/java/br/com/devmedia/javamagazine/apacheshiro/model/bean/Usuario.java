...
public class Usuario {
    ...
    public static Usuario findUsuarioByLoginEquals(String login) {
       
    	Usuario retorno = entityManager().createQuery("SELECT o FROM Usuario o where o.login = ?1", Usuario.class)
    			.setParameter(1, login).getSingleResult();
    	
    	if(retorno == null){
    		throw new EmptyResultDataAccessException("Login não existe", 0);
    	}
        return retorno;
    }
